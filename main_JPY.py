                    ...
                    if order_state:
                        if reversal_valve:
                            ...
                            if rsi_15s > rsi_15s_short:
                                order_id = create_order(limit=round(price,3) - reversal_limit, loss=reversal_loss, units=-1*units)
                                print('trade executed')
                            #reversal_long
                            elif rsi_15s < rsi_15s_long:
                                order_id = create_order(limit=round(price, 3) + reversal_limit, loss=reversal_loss, units=units)
                                print('trade executed')
                            else:
